...
pacstrap /mnt base base-devel efibootmgr feh evince firefox git gnome-terminal file-roller gnome-bluetooth gnome-shell grub htop intel-ucode linux linux-firmware linux-headers totem nautilus gnome-control-center neovim net-tools networkmanager ntfs-3g obs-studio openssh papirus-icon-theme pipewire gdm pipewire-alsa pipewire-jack pipewire-media-session pipewire-pulse xf86-video-intel xorg-server xorg-xinit xorg-xsetroot &&
